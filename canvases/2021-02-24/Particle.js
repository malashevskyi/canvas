...
class Particle {
  ...
  update(mouse) {
    ...
    if (this.tick % this.coordsCount === 0 ||
    ...
    if (this.tick % 4 === 3) {
      // left
      this.x = Math.cos(this.angleY * this.tick + HPi * 4) * this.circlesRadius + this.mouseX - offset;
      this.y = Math.sin(this.angleY * this.tick + HPi * 4) * this.circlesRadius + this.mouseY;
    } else if (this.tick % 4 === 2) {
      // right
      this.x = Math.cos(-this.angleY * this.tick - HPi * 2) * this.circlesRadius + this.mouseX + offset;
      ...
      this.y = Math.sin(this.angleX * this.tick - HPi * 3) * this.circlesRadius + this.mouseY - offset;
