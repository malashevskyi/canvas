class Smile {
  ...
  draw(eyePosition, mouthRadius) {
    ...
    // pupils
    this.context.beginPath();
    this.context.arc(this.x - 38 + eyePosition.x, this.y - 38 + eyePosition.y, 10, 0, Math.PI * 2);
    this.context.arc(this.x + 22 + eyePosition.x, this.y - 38 + eyePosition.y, 10, 0, Math.PI * 2);
    this.context.closePath();
